...
class DinoV2(BaseModel):
    ...
    def __init__(self, use_half=False, device='cpu'):
        ...
        self.processor = AutoImageProcessor.from_pretrained('facebook/dinov2-small', device=device)
        self.model = AutoModel.from_pretrained('facebook/dinov2-small').eval().to(device)
